...
(async () => {
    try {
        ...
        let message = `<p style = "text-align: center; font-family: -apple-system; font-size: large; font-weight: thin"><br><font>🛂 结果 ⤵︎<br>_____________________________<br><br><b>节点类型：${nodeCtlgCnclsn}</b><br>----------------------------------<br>${bgn}-----------------------------${ins}<br>${outs}</font>`;
